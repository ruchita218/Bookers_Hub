...
<%-- Set isELIgnored to false to enable Expression Language (EL) --%>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="register" method="post">
                            ...
                            <div class="form-group">
                                <label for="phnno">Enter Your Contact Number</label>
                                <input type="text" class="form-control" id="phnno" required="required" name="phnno">
                            </div>
                            <div class="form-group">
